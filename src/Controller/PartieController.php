...
//        $parties[] = $partieRepository->findBy(['joueur1' => $this->getUser()->getId()]);
//        $parties[] = $partieRepository->findBy(['joueur2' => $this->getUser()->getId()]);
//        // OU
//        $parties = [];
//        $parties[] = $this->getUser()->getPartiesJ1();
//        $parties[] = $this->getUser()->getPartiesJ2();
        //ou
